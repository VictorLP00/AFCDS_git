...
transfer = tf(SS_lo);
TF_elev_acc = transfer(19,2);

t1 = 0:0.001:5;
resp=step(-TF_elev_acc,t1);
...
hold on
xlabel('Time [s]')
ylabel('Normal acceleration A_n [ft/s^2]')
title('Normal acceleration due to negative step input at 6 different locations')
